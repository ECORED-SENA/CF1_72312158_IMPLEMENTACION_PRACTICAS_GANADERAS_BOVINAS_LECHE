          ...
          .tabla-b
            table
              tr(style="background-color: #FFD63D")
                th.h4.text-center(style="border-right: 2px solid #454545") Composición química
                th.h4.text-center(style="border-right: 2px solid #454545") Nombre comercial
                th.h4.text-center(style="border-right: 2px solid #454545") Usos
              ...
              tr(style="background-color: #FFFFFF")
                th.h4(style="border-right: 2px solid #454545") Hidróxido de sodio + hipoclorito de sodio
                th.h4(style="border-right: 2px solid #454545") SPF BASE CLEAN (Detergente)
